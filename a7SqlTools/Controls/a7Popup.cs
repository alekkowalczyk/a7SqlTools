namespace a7SqlTools.Controls
{
    ...
    /// </summary>
    public class a7Popup : Popup
    {
        /// <summary>
        /// Is Topmost dependency property
        /// </summary>
        public static readonly DependencyProperty IsTopmostProperty = DependencyProperty.Register("IsTopmost", typeof(bool), typeof(a7Popup), new FrameworkPropertyMetadata(false, OnIsTopmostChanged));
